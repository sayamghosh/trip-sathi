  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        ...
        className="relative flex h-[34px] w-[34px] items-center justify-center rounded-[10px] border border-border bg-card transition hover:bg-accent cursor-pointer"
      >
        {theme === "dark" ? (
      ...
      <div className="relative" ref={dropdownRef}>
        {user ? (
          <button 
            ...
            className={`flex items-center gap-2 rounded-[10px] border border-border bg-card px-2.5 py-[5px] transition-colors cursor-pointer hover:bg-accent ${isDropdownOpen ? 'bg-accent' : ''}`}
          >
          ...
          <Link
            to="/login"
            className="flex h-[34px] items-center justify-center rounded-[10px] bg-primary px-5 text-[12px] font-bold text-primary-foreground shadow-sm transition hover:bg-primary/90"
          >
            Sign In
          </Link>
        )}
          ...
          <div className="absolute right-0 mt-2 w-56 origin-top-right rounded-[12px] border border-border bg-card shadow-lg shadow-black/5 ring-1 ring-black ring-opacity-5 focus:outline-none z-50 animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="border-t border-border py-1">
              <button 
                ...
                className="group flex w-full items-center gap-2 px-4 py-2 text-[13px] font-bold text-red-600 transition-colors hover:bg-red-500/10 dark:text-red-400 dark:hover:bg-red-400/10 cursor-pointer"
              >
