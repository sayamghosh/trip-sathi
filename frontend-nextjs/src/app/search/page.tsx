...
function SearchPageContent() {
    ...
    const handleSearch = () => {
        const trimmed = localDestination.trim();
    ...
    return (
        <div className="min-h-screen bg-linear-to-b from-[#f4f7fa] to-white pt-28 pb-20 font-display">
                        ...
                        plans.map((plan, index) => (
                            <Link href={`/guides/${plan._id}`} key={plan._id} className="block">
                                <motion.div
                                    ...
                                    className="bg-white rounded-3xl border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:-translate-y-1 transition-all duration-300 group cursor-pointer h-full overflow-hidden flex flex-col"
                                >
