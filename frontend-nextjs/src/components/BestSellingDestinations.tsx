                ...
                >
                    {destinations.map((dest) => (
                            <Link
                                ...
                                href={{
                                    pathname: '/search',
                                    query: { destination: dest.name.toLowerCase() },
                                }}
                                className="relative group shrink-0 w-39.5 h-55 rounded-2xl overflow-hidden snap-start cursor-pointer block"
                            >
                            {/* Background Image */}
                            <OptimizedImage 
                                src={dest.image} 
                            ...
                            {/* Gradient Overlay */}
                            <div className="absolute inset-0 bg-linear-to-t from-black/90 via-black/20 to-transparent opacity-80 group-hover:opacity-90 transition-opacity duration-300"></div>
