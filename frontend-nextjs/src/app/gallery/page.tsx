...
const galleryImages = [
  {
    ...
    image:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/30/59/66/56/caption.jpg?w=1400&h=-1&s=1",
  },
  {
    id: 2,
    name: "Andaman",
    image:
      "https://images.unsplash.com/photo-1542429296407-20c78e10f375?w=1000&auto=format&fit=crop&q=80",
  },
  {
    id: 3,
    name: "Hotel Greenfields | Manali",
    image:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2f/5a/ae/c9/a-roof-top-restaurant.jpg?w=1000&h=-1&s=1",
  },
  {
    id: 4,
    name: "Pelling | Sikkim",
    image:
      "https://images.unsplash.com/photo-1724600459474-e2a7bd45dede?w=1000&auto=format&fit=crop&q=80",
  },
  {
    id: 5,
    name: "Kashmir",
    image:
      "https://images.unsplash.com/photo-1715457573748-8e8a70b2c1be?w=1000&auto=format&fit=crop&q=80",
  },
  {
    id: 6,
    name: "Udaan Olive Hotel & Spa | Sikkim",
    image:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/24/8a/59/aa/udaan-olive-hotel-spa.jpg?w=1000&h=-1&s=1",
  },
  {
    id: 7,
    name: "Sikkim",
  ...
  },
  {
    ...
    name: "Udaan Olive Hotel & Spa | Sikkim",
    image:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1a/93/ab/67/udaan-olive-hotel-spa.jpg?w=1000&h=-1&s=1",
  },
  {
    id: 9,
    name: "Dal Lake",
  ...
  },
  {
    ...
    image:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/23/48/b6/a7/capital-o-81811-hotel.jpg?w=600&h=-1&s=1",
  },
  {
    id: 11,
    name: "Zanskar",
    image:
      "https://images.unsplash.com/photo-1706021220078-2051d17b1576?w=1000&auto=format&fit=crop&q=80",
  },
  {
    id: 12,
    name: "Hotel Presidency Ladakh | Ladakh",
    image:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2b/df/9e/c2/hotel-presidency-ladakh.jpg?w=1400&h=-1&s=1",
  },
  {
    id: 13,
    name: "Gangtok",
  ...
  },
  {
    ...
    image:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2c/94/5a/80/caption.jpg?w=1400&h=-1&s=1",
  },
  {
    id: 15,
    name: "The Presidency Ladakh | Ladakh",
    image:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2b/df/9e/c3/hotel-rooms-at-hotel.jpg?w=1400&h=-1&s=1",
  },
  {
    id: 16,
    name: "Hotel Fotiya Jaisalmer | Rajasthan",
    image:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0b/71/6f/81/getlstd-property-photo.jpg?w=2000&h=-1&s=1",
  },
  {
    id: 17,
    name: "Hotel Fotiya Jaisalmer | Rajasthan",
    image:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/15/89/90/8d/20181103-102013-largejpg.jpg?w=1000&h=-1&s=1",
  },
  {
    id: 18,
    name: "Rajasthan",
  ...
  },
  {
    ...
    name: "Daman and Diu",
    image:
      "https://images.unsplash.com/photo-1572797751206-35424c13a703?w=1000&auto=format&fit=crop&q=80",
  },
  {
    id: 20,
    name: "The Grand Highness | Diu",
    image:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/11/23/0f/39/parking-is-behind-the.jpg?w=2000&h=-1&s=1",
  },
  {
    id: 21,
    name: "The Grand Highness | Diu",
    image:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1a/0d/bf/6b/photo5jpg.jpg?w=1100&h=-1&s=1",
  },
  {
    id: 22,
    name: "Sky Walk in Pelling | Sikkim",
    image:
      "https://images.unsplash.com/photo-1724600457405-a7eeabcff6b5?w=1000&auto=format&fit=crop&q=80",
  },
  {
    id: 23,
    name: "Whoopers Boutique Kasol | Himachal Pradesh",
    image:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/29/6a/b6/6d/whoopers-boutique-kasol.jpg?w=1400&h=-1&s=1",
  },
  {
    id: 24,
    name: "Hotel Backpackers Inn | Himachal Pradesh",
    image:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0a/aa/ec/57/pine-tree-cafe.jpg?w=1600&h=-1&s=1",
  },
];
      ...
      <section className="mx-auto max-w-[1390px] px-6 py-16 sm:px-10 lg:px-12 lg:py-24">
        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_0.8fr] lg:items-start">
          ...
          <p className="max-w-[430px] pt-4 text-[14px] font-normal leading-[1.65] text-[#73777f] lg:justify-self-end lg:pt-12 lg:text-[16px]">
            Discover beautiful destinations, breathtaking landscapes, and
            unforgettable experiences captured by travelers worldwide.
          </p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-4">
          {[0, 1, 2, 3].map((colIndex) => (
            <div
              key={colIndex}
              className={`flex flex-col gap-6 ${colIndex >= 2 ? "hidden md:flex" : ""} ${colIndex === 3 ? "md:hidden lg:flex" : ""}`}
            >
              {galleryImages
                ...
                .map((image, index) => (
                  <div
                    ...
                    className={`relative cursor-pointer overflow-hidden rounded-[15px] bg-[#f5f5f5] transition-all duration-300 hover:shadow-xl ${
                      (index + colIndex) % 3 === 0
                        ? "aspect-[3/4]"
                        : (index + colIndex) % 2 === 0
                          ? "aspect-[4/5]"
