...
const Footer = () => {
  return (
    <footer className="w-full max-w-[1512px] px-2 pb-3 mx-auto">
      <div className="w-full bg-[#1452D9] rounded-[20px] text-white overflow-hidden">
        <div className="px-4 sm:px-6 lg:px-12 pt-8 sm:pt-10 lg:pt-14 pb-10">
          {/* TOP SECTION */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
            ...
            <div className="lg:col-span-5 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-[22px] sm:text-[30px] lg:text-[40px] leading-[1.1] font-medium max-w-[520px]">
              ...
              <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                ...
                <button className="w-full sm:w-auto h-[52px] px-8 rounded-full bg-white text-black font-medium cursor-pointer hover:bg-neutral-200">
                  Subscribe
                </button>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-8 lg:gap-10">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-3 sm:gap-4 text-sm text-white/75">
