...
export default function OptimizedImage({
    ...
    const optimizedSrc = getOptimizedImageUrl(error && fallbackSrc ? fallbackSrc : src, width);
    ...
    return (
        <div
            className={cn(
                ...
                !loaded && 'animate-shimmer bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 bg-[length:200%_100%]',
                containerClassName,
            )}
            style={{
