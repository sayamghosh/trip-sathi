        ...
        <AnimatePresence>
            ...
            >
                <motion.div
                    ...
                    className="relative flex w-full max-w-215 rounded-2xl overflow-hidden shadow-2xl bg-white"
                    style={{ minHeight: '500px' }}
                >
                    {/* ── LEFT PANEL: Scenic photo ── */}
                    <div className="hidden md:block relative w-[42%] shrink-0 overflow-hidden">
                        <img
