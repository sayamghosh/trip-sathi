...
import { getNewsletterSubscribers } from '../controllers/newsletter.controller.js';
...
router.get('/newsletter-subscribers', authMiddleware, isAdmin, getNewsletterSubscribers);
