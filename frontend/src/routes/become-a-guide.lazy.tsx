...
export const Route = createLazyFileRoute('/become-a-guide')({
    ...
    <div className="min-h-screen bg-gray-50 pt-5 font-sans">
      ...
      <section className="relative bg-brand-primary text-white py-24 px-4 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
          ...
          <div className="absolute bottom-[-20%] left-[-10%] w-[500px] h-[500px] rounded-full bg-brand-dark opacity-30 blur-3xl"></div>
        </div>

        <div className="max-w-6xl mx-auto relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="flex-1 text-center md:text-left">
            {/* <div className="inline-block bg-white/20 backdrop-blur-md px-4 py-2 rounded-full text-sm font-semibold tracking-wide uppercase mb-6 border border-white/30 text-sky-50">
              For Local Experts
            </div> */}
            ...
            <div className="flex flex-col items-center md:items-start mb-2">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 w-full justify-center md:justify-start">
                ...
                >
                  {/* Aura glow ring — animates on hover via CSS group */}
                  <motion.div
      ...
      <section className="py-24 px-4 bg-[#F8FAFC]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="bg-white rounded-[2rem] p-10 shadow-2xl border border-gray-100 relative max-w-xl mx-auto text-left transform hover:scale-[1.02] transition-transform duration-300">
            <div className="absolute top-0 right-8 bg-gradient-to-r from-brand-primary to-sky-400 text-white text-sm font-bold px-4 py-1.5 rounded-b-xl shadow-md uppercase tracking-wide">
              Launch Offer
            </div>
